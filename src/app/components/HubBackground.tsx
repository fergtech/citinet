...
export function HubBackground() {
  ...
  // Classic Citinet wallpaper (rich radial gradients + dot grid) — no longer the
  // fallback, but kept as an explicit "Classic" pick in Appearance for anyone who
  ...
  // True default ('solid', or no preference set yet): a plain theme-aware surface
  // color — --cn-surface-2 already flips between light/dark under the .dark scope.
  return (
    <div
      className="fixed inset-0 -z-10 pointer-events-none"
