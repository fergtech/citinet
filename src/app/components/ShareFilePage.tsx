...
export function ShareFilePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className={`flex-1 flex flex-col items-center p-6 ${isMedia && !loading && !error ? 'justify-start pt-12' : 'justify-center'}`}>
        {loading ? (
            ...
            <div className="text-center w-full">
              ...
              {hubName && (
                <p className="text-xs text-slate-500 mt-1">
                  Shared from <span className="text-slate-400 font-medium">{hubName}</span>
                </p>
              )}
            </div>
            <button
              ...
              <div className="text-center w-full">
                ...
                {hubName && (
                  <p className="text-sm text-slate-400 mt-1.5">
                    Shared from <span className="text-slate-300 font-medium">{hubName}</span>
                  </p>
                )}
              </div>
