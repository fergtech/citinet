...
// components/comms/BroadcastDataBridge.tsx), so this rides that instead of
// adding new hub WebSocket message types.
export type BroadcastMessage =
  ...
  // route to force-close a LiveKit room, so this is what lets every other
  // client react immediately instead of being silently stranded until
  // LiveKit's emptyTimeout (5 min) elapses.
